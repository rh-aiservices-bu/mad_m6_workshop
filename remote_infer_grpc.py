...
class ort_v5:
    def __init__(self, img_data, grpc_host, grpc_port, conf_thres, iou_thres, img_size, classes):
    ...
    def __call__(self):
        ...
        """
        # image preprocessing
        image_or= cv2.imread(self.img_data)
        ...
        #inputs[0].contents = grpc_predict_v2_pb2.InferTensorContents()
        arr = im.flatten()
        for element in arr:
            inputs[0].contents.fp32_contents.append(element)
